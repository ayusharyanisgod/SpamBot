...
rizoel = "✯ Anonymus Spammer Here ✯\n\n"
rizoel += f"═══════════════════\n"
rizoel += f"• **ᴘʏᴛʜᴏɴ ᴠᴇʀsɪᴏɴ** : `3.9.6`\n"
rizoel += f"• **ᴛᴇʟᴇᴛʜᴏɴ ᴠᴇʀsɪᴏɴ** : `{version.__version__}`\n"
rizoel += f"• **Anonymus Spammer ᴠᴇʀsɪᴏɴ**  : `{rizoelversion}`\n"
rizoel += f"═══════════════════\n\n"   
...
async def restart(e):
    if e.sender_id in SUDO_USERS:
        text = "**Restarting Your Anonymus Spammer**.. Please Wait Until It Starts Again"
